  ...
  class Generator
    class MustSupportMetadataExtractor
      ...
      def handle_type_must_support_target_profiles(type, metadata)
        # SHC 3.1.1 profiles do not have SHC target profiles.
        # Vital Sign proifles from FHIR R4 (version 4.0.1) do not have SHC target profiles either.
      ...
      # ONC and SHC 4.0.0 both clarified that health IT developers that always provide HL7 FHIR "observation" values
      ...
      # Since SHC 5.0.1, Blood Pressure profile restores component.dataAbsentReason as MustSupport.
