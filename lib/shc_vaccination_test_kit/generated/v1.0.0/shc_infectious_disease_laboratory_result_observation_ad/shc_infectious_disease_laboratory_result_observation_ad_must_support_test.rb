...
module SHCVaccinationTestKit
  module V100
    class ShcInfectiousDiseaseLaboratoryResultObservationAdMustSupportTest < Inferno::Test
      include SHCVaccinationTestKit::MustSupportTest

      title 'All must support elements are provided in the Shc Infectious Disease Laboratory Result Observation Ad resources returned'
      description %(
      ...
      id :v100_shc_infectious_disease_laboratory_result_observation_ad_must_support_test
